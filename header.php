...
<div id="page" class="site m-scene">
	<a class="skip-link screen-reader-text" href="#main"><?php esc_html_e( 'Skip to content', 'baltimore-medical' ); ?></a>
	
	<div class="container">
			<!-- Logo & Contact Info -->
			<div class="row logo-row">
				<div class="col-md-6">
					<a class="navbar-brand" href="http://copyquality.com/mocksites/medical/"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/img/logo-tagline.png" width="360px"></a>
				</div>
				<div class="col-md-6">
  ...
  <!-- HEADER
	...
	<header class="site-header" role="banner">
		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			...
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'baltimore-medical' ); ?></button>
